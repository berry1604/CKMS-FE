                        ...
                        <div className="bg-zinc-900/40 backdrop-blur-md border border-zinc-800/50 rounded-[40px] p-8 space-y-8 overflow-hidden relative group/sidebar shadow-2xl">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-xs text-zinc-500 font-medium italic leading-relaxed">
                                    Thông tin chi tiết về đơn hàng được khởi tạo từ chuỗi cửa hàng nhượng quyền.
                                </p>
                            </div>
                        ...
                        {orderStatus !== 'REJECTED' ? (
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative flex justify-between">
                                        {[
                                            ...
                                            return (
                                                <div key={item.step} className="flex flex-col items-center gap-5 relative z-10 group/step">
                                                    <div className={cn(
                            ...
                            <div className="flex flex-col items-center gap-6 py-12 bg-red-500/5 rounded-[40px] border border-red-500/20 border-dashed animate-in zoom-in-95 duration-500">
                                ...
                                <div className="text-center space-y-2">
                                    <h5 className="text-[16px] font-black text-red-500 uppercase tracking-[0.2em]">HỆ THỐNG ĐÃ TỪ CHỐI</h5>
                                    <p className="text-[12px] text-zinc-500 font-medium max-w-md mx-auto italic">Vui lòng kiểm tra lại thông tin đơn hàng hoặc liên hệ Coordinator để nhận hỗ trợ kỹ thuật.</p>
                                </div>
                            </div>
                        )}
                                                ...
                                                <tr key={idx} className="group/row hover:bg-white/[0.02] transition-colors">
                                                    <td className="px-8 py-5">
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className="text-[10px] text-zinc-600 font-bold font-mono tracking-tighter italic">Unit ID: {item.productId}</span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td className="px-8 py-5 text-right">
                                                        <div className="flex flex-col items-end">
                                                            ...
                                                            <span className="text-[9px] text-zinc-500 font-bold uppercase tracking-widest">VNĐ</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                            );
