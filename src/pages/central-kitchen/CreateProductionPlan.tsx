          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-8">
            <div>
              ...
              <p className="text-[var(--text-secondary)] max-w-2xl text-sm font-bold leading-relaxed uppercase tracking-wide opacity-80">
                Giao thức gom đơn hàng chi nhánh và phân bổ năng lực{" "}
                <span className="text-amber-500">bếp trung tâm</span> chuyên
                sâu.
              </p>
            </div>
            ...
            <div className="bg-[var(--bg-card)]/40 backdrop-blur-xl border border-[var(--border-primary)] rounded-full px-10 h-20 flex items-center justify-center gap-6 shadow-2xl relative group">
              ...
              <div className="flex flex-col items-end">
                <span className="text-[9px] font-black text-[var(--text-secondary)]/40 uppercase tracking-[0.3em] italic">
                  Batch Selection
                </span>
                <span className="text-2xl font-black text-amber-500 italic tabular-nums leading-none mt-1">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          <span className="text-[10px] text-[var(--text-secondary)]/40 font-black uppercase tracking-[0.2em] italic">
                            Matrix Center Control
                          </span>
                          <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                          <span className="text-[9px] text-emerald-500 font-black uppercase tracking-widest italic leading-none">
                            Vận hành tối ưu
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-wrap items-center gap-6 bg-[var(--bg-root)] p-3 rounded-2xl border border-[var(--border-primary)] shadow-inner">
                      <div className="text-right px-4">
                        ...
                        <div className="flex items-end justify-end gap-2 tabular-nums mt-1">
                          ...
                          <span className="text-xl font-black text-[var(--text-secondary)]/20 italic leading-none">
                            /
                          </span>
                          ...
                          <span className="text-[10px] font-black text-[var(--text-secondary)]/40 uppercase ml-2 italic leading-none mb-1">
                            Items
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 relative group/date min-w-[200px] mt-3">
                        <div className="relative flex-1">
                          <span className="absolute -top-4 left-4 text-[9px] font-black text-[var(--text-secondary)]/40 uppercase tracking-widest italic">
                            Ngày sản xuất
                          </span>
                          <CalendarIcon
                      ...
                      <table className="w-full text-left border-collapse">
                        <thead className="sticky top-0 bg-[var(--bg-card)] z-10 border-b border-[var(--border-primary)]/20">
                          <tr className="text-[10px] uppercase font-black text-[var(--text-secondary)]/40 tracking-[0.3em] italic">
                            ...
                            <th className="px-6 py-6">Mã đơn hàng</th>
                            <th className="px-6 py-6">Cửa hàng</th>
                            ...
                            <tr>
                              ...
                              >
                                <div className="flex flex-col items-center gap-6">
                                  ...
                                  <span className="text-[10px] font-black text-[var(--text-secondary)]/40 uppercase tracking-[0.5em] italic animate-pulse">
                                    Đang rà soát tệp tin đơn hàng...
                                  </span>
                                </div>
                              </td>
                            </tr>
                              ...
                              >
                                <div className="flex flex-col items-center gap-6 opacity-20">
                                  ...
                                  <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[var(--text-secondary)] italic">
                                    Hồ sơ unassigned hiện đang trống
                                  </span>
                                </div>
                              </td>
                            </tr>
                            ...
                            orders.map((order) => (
                              ...
                              >
                                  ...
                                  <div className="flex flex-col gap-2 max-w-[250px]">
                                    {order.orderDetails
                                      ...
                                      .map((i, idx) => (
                                        ...
                                        >
                                          <div className="w-1.5 h-1.5 rounded-full bg-[var(--border-primary)] ml-1 shrink-0"></div>
                                          <span className="text-sm font-medium text-[var(--text-primary)] truncate">
                                            {i.productName}
                                          </span>
                                          <Badge
                                            variant="secondary"
                                            className="bg-[var(--bg-root)] text-[10px] font-black border-[var(--border-primary)]/50 px-2 py-0.5 uppercase italic tracking-tighter"
                                          >
                                            x{i.quantity}
                                          </Badge>
                                        </div>
                                    ...
                                    {order.orderDetails &&
                                      order.orderDetails.length > 3 && (
                                        <span className="text-[10px] text-[var(--text-secondary)]/60 font-black italic ml-4">
                                ...
                                <td className="px-10 py-6 text-right">
                                  <div className="flex flex-col items-end">
                                    <span className="text-[11px] font-black text-amber-500 tracking-widest uppercase italic">
                                      {order.deliveryDate
                                        ? new Date(
                                            order.deliveryDate,
          ...
          {step === 2 && (
            <div className="max-w-4xl mx-auto space-y-10 animate-in slide-in-from-right-8 duration-700 pb-20">
                ...
                <div className="p-10 border-b border-[var(--border-primary)]/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-10 bg-[var(--text-primary)]/[0.01]">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <Badge
                          variant="orange"
                          className="text-[8px] px-3 py-1 h-5 border-0 font-black uppercase tracking-[0.2em] italic rounded-full shadow-inner"
                        >
                          Dự thảo hệ thống
                        </Badge>
                        <span className="text-[10px] text-[var(--text-secondary)]/40 font-black uppercase tracking-widest leading-none italic">
                          Verified Batch Aggregate
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 bg-[var(--bg-root)] p-6 rounded-[2.5rem] border border-[var(--border-primary)] shadow-inner min-w-full md:min-w-[500px]">
                    <div className="space-y-1.5 italic">
                      <span className="text-[9px] font-black text-[var(--text-secondary)]/40 uppercase tracking-widest leading-none block">
                        Bếp Thực thi
                      </span>
                      <p className="text-[11px] font-black text-[var(--text-primary)] uppercase truncate">
                        {
                          kitchens.find(
                    ...
                    <div className="space-y-1.5 border-l border-[var(--border-primary)]/10 pl-6 italic">
                      <span className="text-[9px] font-black text-amber-600/60 uppercase tracking-widest leading-none block">
                        Dự kiến
                      </span>
                ...
                <div className="p-10 space-y-8">
                  <div className="flex justify-between items-center px-4">
                    <div className="flex items-center gap-4">
                      ...
                      <h3 className="text-[10px] font-black text-[var(--text-secondary)]/60 uppercase tracking-[0.3em] italic">
                        Tổng hợp Nhu cầu vĩnh cửu
                      </h3>
                    </div>
                    <Badge
                      variant="info"
                      className="text-[10px] text-indigo-500 font-black px-4 h-6 bg-indigo-500/10 border-indigo-500/20 rounded-full tracking-widest italic"
                    >
                      {aggregatedDemand.length} Loại sản phẩm
                    </Badge>
                  </div>
                      ...
                      <thead className="sticky top-0 bg-[var(--bg-root)] z-10 border-b border-[var(--border-primary)]/10">
                        <tr className="bg-[var(--bg-root)] text-[10px] font-black text-[var(--text-secondary)]/40 uppercase tracking-[0.3em] italic">
                          <th className="px-10 py-6">
                            Thành phẩm & Mã hiệu định danh
                          </th>
                          <th className="px-10 py-6 text-right w-60">
                            Sản lượng đề xuất
                          </th>
                        </tr>
                      </thead>
                              ...
                              <div className="flex items-center gap-6">
                                ...
                                <div className="flex flex-col gap-1">
                                  ...
                                  <span className="text-[10px] text-[var(--text-secondary)]/40 font-black tracking-widest uppercase italic font-mono">
                                    IDENTIFIER:{" "}
                                    <strong className="text-indigo-500/60 ml-1">
                                      #{item.productId}
                                    </strong>
                                  </span>
                                </div>
                  ...
                  <div className="bg-emerald-500/[0.03] rounded-3xl border border-emerald-500/10 p-10 flex flex-col md:flex-row items-center justify-between gap-10 group/yield relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-6 relative z-10">
                      ...
                      <div className="flex flex-col gap-2">
                        <span className="text-[11px] font-black text-emerald-600 uppercase tracking-[0.3em] italic">
                          Phê quyết tổng lượng thực thi
                        </span>
                        <p className="text-xs text-[var(--text-secondary)]/60 font-medium italic uppercase leading-relaxed max-w-[280px]">
                          Dựa trên sự tuyển chọn tinh hoa từ{" "}
                          {selectedOrderIds.size} hồ sơ đơn hàng chi nhánh.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col items-end gap-2 relative z-10">
                      <div className="flex items-center justify-end">
                        {selectedKitchenId &&
                          kitchensInfo[selectedKitchenId] && (
                            <Badge
                              className={cn(
                      ...
                      <div className="flex flex-col items-end pt-1">
                        ...
                        <span className="text-[11px] font-black text-emerald-500/40 uppercase tracking-[0.4em] italic mt-4 leading-none text-right">
                          Aggregate Total Units Output
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-between gap-10 px-8">
                ...
                >
                  <ArrowLeft size={18} className="mr-3" /> Quay lại trạm kiểm
                  soát
                </Button>
