  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth(year, month); day++) {
      ...
      days.push(
        <div
          key={day}
          className="min-h-[140px] border-b border-r border-zinc-800/50 p-3 flex flex-col group relative hover:bg-zinc-900/30 transition-all"
        >
                            ...
                            >
                              ...
                              <td className="px-6 py-4 text-right pr-8">
                                {!stockKnown ? (
                                  <Info
                                    size={14}
                                    className="text-zinc-800 inline ml-auto"
                                  />
                                ) : sufficient ? (
                                  ...
                                  <div className="flex items-center justify-end gap-1.5 text-red-500">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-tight shrink-0">
                                      Thiếu {mat.requiredQuantity - available!}
                                    </span>
                                  </div>
                                )}
                              </td>
