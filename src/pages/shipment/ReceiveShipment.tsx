...
export const ReceiveShipment = () => {
  ...
  >("IN_TRANSIT"); // Default to incoming
  ...
  const filteredShipments = shipments.filter((s) => {
    if (statusFilter !== "all") {
      if (
        ...
        return false;
      } else if (statusFilter !== "IN_TRANSIT" && s.status !== statusFilter) {
        return false;
      }
    }
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge
        ...
        className="px-2 py-0.5 border-0 font-black text-[10px] tracking-widest uppercase"
      >
        {item.label}
      </Badge>
    );
      ...
      <div className="relative h-[320px] w-full overflow-hidden group/header">
        ...
        <div className="absolute inset-0 flex flex-col justify-end px-8 pb-12 max-w-7xl mx-auto w-full">
          <div className="flex items-center gap-4 mb-3">
            ...
            <span className="text-amber-500 font-black tracking-[0.3em] text-[10px] uppercase italic">
              Điều phối nhập kho
            </span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-6">
            ...
            <div className="px-6 py-3 backdrop-blur-3xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl">
              <span className="text-[var(--text-secondary)] text-[10px] uppercase tracking-[0.2em] block mb-1 font-black">
                Tổng chuyến hàng
              </span>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center justify-between relative z-10">
            <div className="relative w-full md:w-[400px] group/search">
              <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none transition-transform group-focus-within/search:scale-110">
                <Search
                  size={18}
                  className="text-[var(--text-secondary)] group-focus-within/search:text-amber-500 transition-colors"
                />
              </div>
              <input
                type="text"
            ...
            <div className="flex items-center gap-3 w-full md:w-auto overflow-x-auto pb-2 md:pb-0 no-scrollbar">
              <div className="flex items-center gap-2 pr-4 border-r border-[var(--border-primary)] mr-2">
                ...
                <span className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-widest whitespace-nowrap">
                  HIỂN THỊ
                </span>
              </div>
        ...
        <div>
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-32 gap-6 scale-110">
              ...
              <span className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-[0.4em] animate-pulse">
                Luân chuyển dữ liệu...
              </span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-32 text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <h3 className="text-xl font-bold text-[var(--text-secondary)] uppercase tracking-tighter mb-3">
                Hệ thống trống
              </h3>
              <p className="text-[var(--text-secondary)]/60 max-w-sm mx-auto font-light italic">
                Không tìm thấy chuyến hàng nào khớp với điều kiện hiện tại.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredShipments.map((shipment, idx) => (
                ...
                >
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="p-5 rounded-3xl bg-[var(--bg-root)]/50 border border-[var(--border-primary)] group-hover:border-[var(--text-secondary)]/20 transition-colors relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <div className="text-[9px] font-black text-[var(--text-secondary)] uppercase tracking-[0.2em] mb-1">
                              Cơ trưởng chuyến hàng
                            </div>
                            <div className="text-sm font-bold text-[var(--text-primary)] tracking-tight">
                              {shipment.driverName || "Vô danh"}
                            </div>
                  ...
                  <Button
                    onClick={() =>
                      navigate(`/shipment/receive/${shipment.shipmentId}`)
                    }
                    className={cn(
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center justify-center gap-2">
                      ...
                      shipment.status === "ARRIVED" ? (
                        <>
                          XÁC NHẬN NHẬN HÀNG <Eye size={16} />
                        </>
                      ) : (
                        <>
